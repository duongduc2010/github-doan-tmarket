<?php
	...
	if(isset($_POST['submit'])){
		if(!empty($_POST['tlkh'])  && !empty($_POST['tgbatdau']) && !empty($_POST['tgketthuc']) && !empty($_POST['cahoc'])){
			...
			$sql_sua = "UPDATE khoahocgiaovien SET theloaikhoahocid = '$tlkh', thoigianbatdau = '$tgbatdau', thoigianketthuc ='$tgketthuc',cahoc = '$cahoc', tailieu1='$tailieu1',tailieu2='$tailieu2'
			WHERE giaovienid='$id_giaovien' and id='$id_khgv'";
		...
		<div class="chitiet__thietlapkhoahoc">
			<form method="post" enctype="multipart/form-data">
				...
				<!-- <fieldset class="chitiet__hocphidong form-group">
					...
					<span>VND</span>
					<input name="hocphi"  min="1000" max="2000000" type="number" placeholder="Nhập học phí: " class="chitiet__hocphi form-control" id="hocphi"/>
				</fieldset> -->
				<fieldset class="form-group">
					<label for="tgbatdau">Thời gian bắt đầu: </label>
					<input name="tgbatdau"  type="date" placeholder="Nhập học phí: " class="chitiet__tgbatdau form-control" id="tgketthuc"/>

				</fieldset>
				<fieldset class="form-group">
					<label for="tgketthuc">Thời gian kết thúc: </label>
					<input name="tgketthuc" type="date" placeholder="Nhập học phí: " class="chitiet__tgbatdau form-control" id="tgketthuc"/>
				</fieldset>
				<fieldset class="form-group">
					<label for="cahoc">Ca học: </label>
					<select name="cahoc"  id="cahoc" class="chitiet__cahoc form-control">
				...
				<fieldset class="form-group">
					<input name="submit" type="submit" class="chitiet__btn form-control" id="taokh" value="Sửa khóa học">
				</fieldset>
			</form>
		</div>
	</div>
