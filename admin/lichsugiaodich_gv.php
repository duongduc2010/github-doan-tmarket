<?php
    ...
    $sql_lsgd = "SELECT lichsugiaodich.*, giaovien.hoten 
                    FROM lichsugiaodich,giaovien
                    WHERE giaovien.id = lichsugiaodich.idgiaovien";
    ...
    $sql_sl = "SELECT count(id) as dem FROM lichsugiaodich";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Lịch sử giao dịch của giáo viên (<?php echo $slusers?>)</h2>
            </div>
