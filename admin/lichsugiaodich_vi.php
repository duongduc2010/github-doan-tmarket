<?php
    ...
    $sql_lsgd = "SELECT lsgiaodich.*, taikhoan.hoten 
                    FROM lsgiaodich,taikhoan
                    WHERE taikhoan.id = lsgiaodich.idtaikhoan";
    ...
    $sql_sl = "SELECT count(id) as dem FROM lsgiaodich";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Lịch sử giao dịch Ví Tmarket (<?php echo $slusers?>)</h2>
            </div>
