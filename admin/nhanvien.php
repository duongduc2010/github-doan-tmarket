<?php
    ...
    $sql_sl = "SELECT count(id) as dem FROM admin";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Nhân viên (<?php echo $slusers?>)</h2>
                <a class="btn_themkh" href="nhanvien_themmoi.php">Thêm mới</a>
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $items['taikhoan'];?></td>
                            <td><?php echo $items['hoten'];?></td>
                            <td><?php echo $items['email'];?></td>
                            <td><?php echo $items['thoigiantao'];?></td>
                            <td><a class="btn-xoa" href="nhanvien_xoa.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
