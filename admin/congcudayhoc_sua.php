<?php
	...
	if(isset($_POST['submit'])){
		if(!empty($_POST['ten'])){
			$ten = $_POST['ten'];
			$sql_them = "UPDATE congcudayhoc SET tencongcu='$ten' WHERE id = '$id'";
...
<body>
	<div class="pdgv_chitiet">
		<div class="pdgv_h1">
			<h1>Sửa Công cụ dạy học</h1>
		</div>
		<div class="form">
			<form method = "post">
				<fieldset class="form-group">
					<label for="ten">ID</label>
					<input disabled type="text" class="form-control" value="<?php echo $id?>" id="ten">
				</fieldset>
				<fieldset class="form-group">
					<label for="ten">Tên công cụ dạy học</label>
