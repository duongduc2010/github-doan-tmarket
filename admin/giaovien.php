<?php
    ...
    $sql_gv = "SELECT giaovien.*, theloaigiaovien.tentheloai
                FROM giaovien,theloaigiaovien
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Giáo viên (<?php echo $slusers?>)</h2>
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $items['linkdayhoc'];?></td>
                            <td><a class="btn-thongtinchitiet" href="giaovien_chitiet.php?idpdgv=<?php echo $items['id']?>"><i class="fa-solid fa-eye"></i></a></td>
                            <td><a class="btn-xoa" href="giaovien_xoa.php?idpdgv=<?php echo $items['id']?>&&taikhoan=<?php echo $items['taikhoan']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
