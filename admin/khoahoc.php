<?php
    ...
    $sql_sl = "SELECT count(id) as dem FROM theloaikhoahoc";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Khóa học (<?php echo $slusers?>)</h2>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn-thongtinchitiet" href="khoahoc_chitiet.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-eye"></i></a></td>
                            <td><a class="btn-sua" href="khoahoc_sua.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-pencil"></i></a></td>
                            <td><a class="btn-xoa" href="khoahoc_xoa.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
