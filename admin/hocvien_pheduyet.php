<?php
    ...
    $sql_khhv = "SELECT khoahochocvien.id,khoahocgiaovien.id as khgv,khoahochocvien.idhocvien,theloaikhoahoc.tenkhoahoc,giaovien.hoten as tengv,taikhoan.hoten as tenhv,taikhoan.id as idtk
                FROM khoahochocvien,theloaikhoahoc,giaovien,taikhoan,khoahocgiaovien
                WHERE khoahochocvien.tinhtrang='Đang phê duyệt'
    ...
    $sql_sl = "SELECT count(id) as dem FROM khoahochocvien WHERE tinhtrang='Đang phê duyệt'";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Phê duyệt khóa học (<?php echo $slusers?>)</h2>
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $items['tenhv'];?></td>
                            <td>Chưa thanh toán</td>
                            <td><a class="btn-sua" href="hocvien_pheduyet_dongy.php?id=<?php echo $items['id']?>&&idhv=<?php echo $items['idhocvien']?>&&khgv=<?php echo $items['khgv']?>&&idtk=<?php echo $items['idtk']?>"><i class="fa-solid fa-check"></i></a></td>
                            <td><a class="btn-xoa" href="hocvien_pheduyet_tuchoi.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
