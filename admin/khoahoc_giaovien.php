<?php
    ...
    $sql_kh = "SELECT khoahocgiaovien.*,theloaikhoahoc.tenkhoahoc,giaovien.hoten 
                FROM khoahocgiaovien,theloaikhoahoc,giaovien
                WHERE khoahocgiaovien.theloaikhoahocid = theloaikhoahoc.id
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Khóa học giáo viên (<?php echo $slusers?>)</h2>
                <!-- <a class="btn_themkh" href="khoahoc_them.php">Thêm mới</a> -->
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $items['tinhtrang'];?></td>
                            <td><a class="btn-sua" href="khoahoc_giaovien_them.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-pencil"></i></a></td>
                            <td><a class="btn-thongtinchitiet" href="khoahoc_giaovien_chitiet.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-eye"></i></a></td>
                            <td><a class="btn-xoa" href="khoahoc_giaovien_xoa.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
