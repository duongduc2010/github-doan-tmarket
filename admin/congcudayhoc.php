<?php
    ...
    $sql_sl = "SELECT count(id) as dem FROM congcudayhoc";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Công cụ dạy học (<?php echo $slusers?>)</h2>
                <a class="btn_themkh" href="congcudayhoc_themmoi.php">Thêm mới</a>
            </div>
            <div class="chitiet_content">
                <table class="table table-inverse">
                    ...
                    <tbody>
                        <?php $i=1; foreach($result_ccdh as $items):?>
                        <tr>
                            <td><?php echo $i;?></td>
                            <td><?php echo $items['id'];?></td>
                            <td><?php echo $items['tencongcu'];?></td>
                            <td><a class="btn-sua" href="congcudayhoc_sua.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-pencil"></i></a></td>
                            <td><a class="btn-xoa" href="congcudayhoc_xoa.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
