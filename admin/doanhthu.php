<?php
    ...
    $sql_lsgd = "SELECT doanhthu.*, theloaikhoahoc.tenkhoahoc 
                    FROM doanhthu,theloaikhoahoc,khoahocgiaovien
                    WHERE doanhthu.idkhoahoc = khoahocgiaovien.id
    ...
    $sql_sl = "SELECT sum(sotien) as dem FROM doanhthu";
    ...
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Doanh thu</h2>
                <h4>Tổng tiền: <?php echo $slusers?> VNĐ</h4>
            </div>
