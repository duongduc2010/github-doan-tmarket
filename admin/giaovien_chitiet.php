<?php
	...
	$id_pdgv = $_GET['idpdgv'];
	$sql_chitiet = "SELECT giaovien.*, quocgia.quocgia as tenqg, gioitinh.gioitinh as tengt , theloaigiaovien.tentheloai
		FROM giaovien, quocgia,gioitinh,theloaigiaovien
		WHERE giaovien.id = '$id_pdgv' 
...
<body>
			...
			<form style="height: 2500px;" >
				...
				<fieldset class="form-group">
					...
					<video controls="controls" class="form-control"  style=" height: 250px;">
						<source src="../teacher/<?php echo $items['video'];?>">
					</video>
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Id card mặt trước</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['idcard1']?>">
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Id card mặt sau</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['idcard2']?>">
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Chứng chỉ bằng cấp</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['chungchi1']?>">
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Thông tin thêm về chứng chỉ</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['chungchi2']?>">
				</fieldset>
			</form>
			<form style="height: 2500px;">
				<fieldset class="form-group">
				...
				<fieldset class="form-group">
					...
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['congcu1']?>">
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Laptop</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['congcu2']?>">
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Tai nghe</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['congcu3']?>">
				</fieldset>
				<fieldset class="form-group">
					<label for="gth1">Camera</label>
					<img style="height: 250px" class="form-control" name="gth1" src="../teacher/<?php echo $items['congcu4']?>">
				</fieldset>
			</form>
			<?php endforeach?>
	...
	<a href="giaovien.php"><input class="btn_quaylai" type="submit" value="Quay lại"></a>
</body>
</html>