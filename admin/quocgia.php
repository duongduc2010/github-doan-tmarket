<?php
    ...
    $sql_sl = "SELECT count(id) as dem FROM quocgia";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Quốc gia (<?php echo $slusers?>)</h2>
                <a class="btn_themkh" href="quocgia_themmoi.php">Thêm mới</a>
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $items['quocgia'];?></td>
                            <td><a class="btn-sua" href="quocgia_sua.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-pencil"></i></a></td>
                            <td><a class="btn-xoa" href="quocgia_xoa.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
