<?php
	...
	if(isset($_POST['submit'])){
		if(!empty($_POST['hocphi'])){
			$hocphi = $_POST['hocphi'];
			$sql = "UPDATE khoahocgiaovien SET hocphi ='$hocphi' WHERE id = '$id'";
...
<body>
		...
		<div class="form">
			...
			<form method="post" >
				...
				<fieldset class="form-group">
					...
					<input type="number" class="form-control" id="hocphi" value="<?php echo $items['hocphi']?>" name="hocphi">
				</fieldset>
				<fieldset class="form-group">
					<input type="submit" class="form-control" id="hocphi" name="submit" value="Thiết lập học phí">
				</fieldset>
			</form>
			<form>
				<fieldset class="form-group">
	...
	<a href="khoahoc_giaovien.php"><input class="btn_quaylai" type="submit" value="Quay lại"></a>
</body>
</html>