<?php
    ...
    $sql_hv = "SELECT * FROM taikhoan WHERE phanquyen='2'";
    ...
    $sql_sl = "SELECT count(id) as dem FROM taikhoan WHERE phanquyen='2'";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Học viên (<?php echo $slusers?>)</h2>
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Đã thanh toán</td>
                            <td><a class="btn-thongtinchitiet" href="hocvien_chitiet.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-eye"></a></td>
                            <td><a class="btn-xoa" href="hocvien_xoa.php?id=<?php echo $items['id']?>"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
