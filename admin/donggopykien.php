<?php
    ...
    $sql_lsgd = "SELECT * FROM donggopykien";
    ...
    $sql_sl = "SELECT count(id) as dem FROM donggopykien";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Đóng góp ý kiến (<?php echo $slusers?>)</h2>
            </div>
                ...
                <table class="table table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $items['ykiendonggop'];?></td>
                        </tr>
                        <?php $i++; endforeach?>
                    </tbody>
                </table>      
