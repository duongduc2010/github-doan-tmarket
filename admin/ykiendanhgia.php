<?php
    ...
    $sql_admin = "SELECT ykiendanhgia.*,theloaikhoahoc.tenkhoahoc,taikhoan.hoten 
                  FROM ykiendanhgia,khoahocgiaovien,theloaikhoahoc,taikhoan
                  WHERE ykiendanhgia.idkhoahoc = khoahocgiaovien.id
                  and khoahocgiaovien.theloaikhoahocid = theloaikhoahoc.id
                  and taikhoan.id = ykiendanhgia.idhocvien";
    ...
    $sql_sl = "SELECT count(id) as dem FROM ykiendanhgia";
...
<body>
    <div id="content">
        <div id="admin__sidebar">
         ...
         <div id="main_content">
            <div class="title">
                <h2>Ý kiến đánh giá (<?php echo $slusers?>)</h2>
            </div>
