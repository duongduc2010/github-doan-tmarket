...
<body>
	...
	<div id="content">
		...
		<div class="huongdansd">
			...
			<div class="danhcho">
				<div class="hocvien">
					...
					<div class="nut">
						<a class="ct" href="huongdanwithhv.php">Xem chi tiết</a>
				...
				<div class="giaovien">
					...
					<p>Tmarket là nền tảng kết nối giữa Giáo viên và Học viên có nhu cầu học Ngoại ngữ, thông qua các lớp học trực tuyến với mô hình học 1 Thầy-1 Trò hoặc 1 Thầy-1 nhóm và lớp học được thực hiện trên nền tảng Zoom, Google meet, …</p>
					<div class="nut">
						<a class="ct" href="huongdanwithgv.php">Xem chi tiết</a>
						<a class="vd" href="#">Xem video</a>
					</div>
				</div>
			</div>
		...
		<a href="cauhoithuonggap.php"><input id="chtg" type="submit" name="" value="HIỂN THỊ THÊM"></a>
