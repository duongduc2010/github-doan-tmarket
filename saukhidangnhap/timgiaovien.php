                        ...
                        <div class="content_card-info">
                            <div class="content_card-info_tc">
                                <div class="content_card-info_tc1">
                                    ...
                                    <a href="chitietkhoahochv.php?id=<?php echo $iduser?>&&idgv=<?php echo $items['id']?>" class="content_card-sub">Các khóa học</a>
                                </div>
...
<!--                 <div class="dsgv">
                    ...
                    <div class="tgv">
                        <h2 class="tgv-title">Bài học tức thời</h2>
                        <h5 class="tgv-desc">Bạn muốn thực hiện một bài học ngay lúc này? Tìm giáo viên mà có sẵn ngay bây giờ và bắt đầu học!</h5>
                    </div>
                    <div class="gv">
                        <div class="giaovien">
                            <div class="gv-header">
                                <div class="gv-header_img">
                                    <img src="img/quang.jpg" alt="">
                                </div>
                                <div class="gv-header_desc">
                                    <h6>Đỗ Tràng Nhật Quang</h6>
                                    <h7>Giáo viên chuyên nghiệp</h7>
                                    <br>
                                    <h7>Đến từ Hàng Hải</h7>
                                </div>
                            </div>
                            <video width="330" height="150" controls>
                              <source src="img/quang.mp4" type="video/mp4">
                            </video>
                            <div class="giaovien-detail">
                                <div class="giaovien-detail_left">
                                    <div>3⭐⭐⭐</div>
                                    <div>Học thử</div>
                                    <div class="price">25000 VND</div>
                                </div>
                                <div class="giaovien-detail_right">
                                    <a href="">Xem chi tiết</a>
                                    <div>Học chính thức</div>
                                    <div class="price">55000 VND</div>
                                </div>
                            </div>
                        </div>
                        <div class="giaovien">
