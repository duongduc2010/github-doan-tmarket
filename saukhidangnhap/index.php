...
<body>
	...
	<div id="content">
		...
		<div class="timgv">
			<a href="timgiaovien.php?id=<?php echo $iduser?>">
				<input type="submit" name="" value="Tìm giáo viên">
			</a>
			<img src="img/anh banner.jpg">
		</div>
		<div class="muonhoc">
			<h1>TÔI MUỐN HỌC</h1>
			<ul class="nav">
		...
		<div class ="dsgv">
			...
			<div class="product__pagination">
	            <?php if($pageNum>1){?>
					<a href="index.php?pageNum=<?id=<?php echo $iduser?>&&php echo $pagePrev?>"> < </a>
				<?php }?>
				<?php for($i=$from;$i<=$to;$i++){?>
					<?php if($i==$pageNum){?>
						<a class="active" href="index.php?id=<?php echo $iduser?>&&pageNum=<?php echo $i?>"><?php echo $i?></a>
					<?php } else {?>
						<a href="index.php?id=<?php echo $iduser?>&&pageNum=<?php echo $i?>"><?php echo $i?></a>
	        		<?php }?>
	        	<?php }?>
	        	<?php if($pageNum<$tongSoTrang){?>
					<a href="index.php?id=<?php echo $iduser?>&&pageNum=<?php echo $pageNext?>"> > </a>
				<?php }?>
	        </div>
		</div>
		<div class="cacbuocsd">
			<h1>CÁC BƯỚC SỬ DỤNG TMARKET</h1>
			<img src="img/hdsd.jpg">
		...
		<div class="huongdansd">
			...
			<div class="danhcho">
				<div class="hocvien">
					...
					<div class="nut">
						<a class="ct" href="huongdanwithhv.php?id=<?php echo $iduser?>">Xem chi tiết</a>
				...
				<div class="giaovien">
					...
					<p>Tmarket là nền tảng kết nối giữa Giáo viên và Học viên có nhu cầu học Ngoại ngữ, thông qua các lớp học trực tuyến với mô hình học 1 Thầy-1 Trò hoặc 1 Thầy-1 nhóm và lớp học được thực hiện trên nền tảng Zoom, Google meet, …</p>
					<div class="nut">
						<a class="ct" href="huongdanwithgv.php?id=<?php echo $iduser?>">Xem chi tiết</a>
						<a class="vd" href="#">Xem video</a>
					</div>
				</div>
			</div>
		...
		<div class="baihoctgv">
			<div class="hang">
				...
				<img src="img/1kem1.jpg">
			</div>
			<div class="hang">
				<img src="img/lophoc.jpg">
				<div class="gth2">
		...
		<div class="cauhoitg">
			<div class="cot1">
				<div class="cau1">
					<h6><img src="img/QA.jpg">Bài học thử là gì</h6>
				...
				<div class="cau2">
					<h6><img src="img/QA.jpg">Khi nào và làm thế nào để khiếu nại một vấn đề của buổi học?</h6>
				...
				<div class="cau3">
					<h6><img src="img/QA.jpg">Làm thế nào để sử dụng bài học tức thời?</h6>
		...
		<input id="chtg" type="submit" name="" value="HIỂN THỊ THÊM">
		<div class="gopy">
			<div class="feedback">
				<form method="post">
			...
			<img src="img/green-background.jpg">
		</div>
