...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/diemso.css">
...
<body>
	...
	<div id="content">
		<div class="diem">
			...
			<h2><?php echo $diemso?>/<?php echo $tong?></h2>
		</div>
		<a class="back" href="danhsachbaitap.php?id=<?php echo $iduser?>&&idkh=<?php echo $idkh?>">Trở về</a>
	</div>
