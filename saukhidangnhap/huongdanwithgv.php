...
<body>
	...
	<content >
		...
		<section class="muc mot">
			...
			<p>Đường dẫn phần mềm bản chính thức: <a href="index.php?id=<?php echo $iduser?>">https://tmarket.edu.vn/</a></p>
		...
		<section class="muc hai">
			...
			<h5>Bước 1: Truy cập vào địa chỉ <a href="index.php?id=<?php echo $iduser?>">https://tmarket.edu.vn/</a></h5>
